---
title: "Data scaling and imputation, Part 1"
...
Next, I only keep drug vulnerability information for compounds that have been studied in the NCI Match signal-finding trial or that have been covered in the MD Anderson Precision Medicine Database.
...
crxg %>% 
  ...
  ggsave("center_ic50.pdf", width = 3, height = 2)
```
